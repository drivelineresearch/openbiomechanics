...
The OpenBiomechanics Project is an initiave started by [Driveline Baseball Research & Development](https://drivelinebaseball.com/research/) to provide raw (in the form of cleaned C3D files) and processed (full signal + point of interest) sports biomechanics data to the general public. For more information, read the documentation below and visit the [project homepage](https://openbiomechanics.org):
